...
const Navbar = () => {
  ...
  // Helper function to check active state including hash comparison
  ...
  return (
    <header className="w-full block flex-none relative z-50">
      ...
      <div className="hidden lg:block w-full px-6">
        <div className="mx-auto max-w-[1528px] bg-[#FBFBFB] border border-black/10 rounded-xl font-sans text-black overflow-hidden">
      ...
      <div className="w-full hidden lg:block mt-6 px-6">
        <div className="mx-auto max-w-[1528px] flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 shrink-0">
            ...
            {user ? (
              <button
                ...
                className="px-6 h-11 bg-[#03081F] text-white rounded-full flex items-center gap-2 font-sans text-xs font-semibold hover:opacity-90 transition-opacity whitespace-nowrap cursor-pointer"
              >
      ...
      {/* Mobile Navbar */}
      <div className="lg:hidden w-full px-4 bg-white border-b border-gray-200 font-sans">
