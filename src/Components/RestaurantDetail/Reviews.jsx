...
const Reviews = () => {
  ...
  return (
    <div className="relative bg-gradient-to-b from-[#fdfdfd] to-[#f4f4f4] w-full py-12 lg:py-16 rounded-2xl overflow-hidden shadow-sm border border-gray-100">
      ...
      <div className="hidden lg:block w-full px-8 relative">
        <div className="w-full flex items-end justify-between mb-8">
          <div>
            <h2 className="font-heading font-extrabold text-[36px] xl:text-[42px] leading-tight text-brand-dark tracking-tight">
              Customer Reviews
            </h2>
          ...
          <div className="flex gap-4">
            <button
              onClick={handlePrev}
              className="w-[50px] h-[50px] bg-white border border-gray-200 shadow-sm rounded-full flex items-center justify-center text-brand-orange hover:bg-brand-orange hover:text-white cursor-pointer transition-all duration-300"
            >
              <span className="text-lg font-bold">&lt;</span>
            </button>
            <button
              onClick={handleNext}
              className="w-[50px] h-[50px] bg-brand-orange shadow-md hover:shadow-lg rounded-full flex items-center justify-center text-white cursor-pointer hover:bg-brand-orange/90 transition-all duration-300"
            >
              <span className="text-lg font-bold">&gt;</span>
            </button>
          </div>
        ...
        <div className="w-full grid grid-cols-3 gap-6">
          {visibleDesktop.map((review) => (
            <div
              ...
              className="w-full bg-white p-6 xl:p-8 flex flex-col justify-between rounded-[20px] shadow-md border border-gray-50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="flex items-center justify-between w-full border-b border-gray-100 pb-5 mb-5">
                <div className="flex items-center gap-3">
                  <div className="w-[48px] h-[48px] rounded-full bg-gray-200 overflow-hidden ring-4 ring-brand-orange/10 shrink-0">
                    <img
                      src={review.image}
                      alt={review.name}
                      className="w-full h-full object-cover"
                  ...
                  <div className="w-[3px] h-[36px] bg-brand-orange rounded-full shrink-0"></div>
                  <div className="flex flex-col">
                    <span className="font-heading font-bold text-[16px] text-[#03081F] leading-tight">
                      {review.name}
                    </span>
                    <span className="font-body font-semibold text-[13px] text-brand-orange leading-tight mt-0.5">
                      {review.location}
                    </span>
                  </div>
                </div>
              ...
              <p className="font-body font-normal text-[14px] xl:text-[15px] leading-[22px] xl:leading-[24px] text-gray-600 italic flex-1">
                "{review.text}"
              </p>
            </div>
          ))}
